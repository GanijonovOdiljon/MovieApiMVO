...
import com.example.movieappmvi.databse.MovieDatabase
...
class DetailFragment : Fragment(R.layout.fragment_detail) {
    ...
    private var _binidng: FragmentDetailBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binidng = FragmentDetailBinding.bind(view)
        ...
        binding.btnDelSv.setOnClickListener {
            viewLifecycleOwner.lifecycleScope.launch {
                if (isSaved) {
                    ...
                    viewModel.channel.send(DetailIntent.OnSavedClicked(movie?.toMovieEntity()!!))
